    ...
    <v-container class="mt-5">
        <v-layout wrap>
            <v-flex xs12>
                ...
                <v-data-table :headers="headers" :items="category" sort-by="calories" class="elevation-1 mb-5">
                    <template v-slot:top>
...
export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Активно', align: 'right', value: 'active' },
    ...
    methods: {
        ...
        deleteItem (item) {
            ...
            confirm('Are you sure you want to delete this item?') && this.category.splice(index, 1)
        ...
        save () {
            this.$axios.post(this.$route.path, this.editedItem).then(res => {
                ...
                if (this.editedIndex > -1) {
                    Object.assign(this.category[this.editedIndex], res.data.data)
                } else {
